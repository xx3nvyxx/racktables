...
class RTPermissionDenied extends RackTablesError
{
	public function dispatch()
	{
		...
		echo serializeTags ($context['user']) . "&nbsp;</td></tr>\n";
		echo "<tr><th width='50%' class=tagchain>Target given tags:</th><td class=tagchain>";
		echo serializeTags ($context['target']) . "&nbsp;</td></tr>\n";
		echo "<tr><th width='50%' class=tagchain>View given tags:</th><td class=tagchain>";
		echo serializeTags ($context['view']) . "&nbsp;</td></tr>\n";
